...
inline const auto histogram_txt =
    x3::rule<class histogram_txt, ast::histogram_expr>("histogram");
...
inline const auto histogram_txt_def =
...
BOOST_SPIRIT_DEFINE(histogram_txt);
